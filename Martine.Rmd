...
```{r}
#making participant id = SUBJ in demo_train 
...
#renaming variable so i can merge the visit1 with f_df 
...
#The dollar in the A is because then you cant do dumb tuff  
